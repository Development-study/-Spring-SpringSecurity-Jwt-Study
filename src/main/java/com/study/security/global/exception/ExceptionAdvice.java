...
import com.study.security.global.exception.presentation.dto.ExceptionDto;
...
public class ExceptionAdvice {
    ...
    public ResponseEntity<Object> handleAdminErrorException(CustomException exception) {
        return new ResponseEntity<>(new ExceptionDto(exception.getErrorCode().getMessage()), exception.getErrorCode().getStatus());
    }
